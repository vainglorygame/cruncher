...
select
    ...
    sum(heal_heal_ally),
    sum(heal_healed_ally),
    sum(heal_heal_other),
    sum(heal_healed_other),
    sum(heal_rcvd_heal_hero),
    sum(heal_rcvd_healed_hero),
    sum(heal_rcvd_healed_vamp),
    sum(heal_rcvd_heal_ally),
    sum(heal_rcvd_healed_ally),
...
ability_a_use = ability_a_use + values(ability_a_use),
ability_b_use = ability_b_use + values(ability_b_use),
ability_c_use = ability_c_use + values(ability_c_use),
ability_a_damage_true = ability_a_damage_true + values(ability_a_damage_true),
ability_a_damage_dealt = ability_a_damage_dealt + values(ability_a_damage_dealt),
ability_b_damage_true = ability_b_damage_true + values(ability_b_damage_true),
ability_b_damage_dealt = ability_b_damage_dealt + values(ability_b_damage_dealt),
ability_c_damage_true = ability_c_damage_true + values(ability_c_damage_true),
ability_c_damage_dealt = ability_c_damage_dealt + values(ability_c_damage_dealt),
ability_perk_damage_true = ability_perk_damage_true + values(ability_perk_damage_true),
ability_perk_damage_dealt = ability_perk_damage_dealt + values(ability_perk_damage_dealt),
ability_aa_damage_true = ability_aa_damage_true + values(ability_aa_damage_true),
ability_aa_damage_dealt = ability_aa_damage_dealt + values(ability_aa_damage_dealt),
ability_aacrit_damage_true = ability_aacrit_damage_true + values(ability_aacrit_damage_true),
ability_aacrit_damage_dealt = ability_aacrit_damage_dealt + values(ability_aacrit_damage_dealt),
heal_heal_hero = heal_heal_hero + values(heal_heal_hero),
heal_healed_hero = heal_healed_hero + values(heal_healed_hero),
heal_heal_ally = heal_heal_ally + values(heal_heal_ally),
heal_healed_ally = heal_healed_ally + values(heal_healed_ally),
heal_heal_other = heal_heal_other + values(heal_heal_other),
heal_healed_other = heal_healed_other + values(heal_healed_other),
heal_rcvd_heal_hero = heal_rcvd_heal_hero + values(heal_rcvd_heal_hero),
heal_rcvd_healed_hero = heal_rcvd_healed_hero + values(heal_rcvd_healed_hero),
heal_rcvd_healed_vamp = heal_rcvd_healed_vamp + values(heal_rcvd_healed_vamp),
heal_rcvd_heal_ally = heal_rcvd_heal_ally + values(heal_rcvd_heal_ally),
heal_rcvd_healed_ally = heal_rcvd_healed_ally + values(heal_rcvd_healed_ally),
heal_rcvd_heal_other = heal_rcvd_heal_other + values(heal_rcvd_heal_other),
heal_rcvd_healed_other = heal_rcvd_healed_other + values(heal_rcvd_healed_other),
